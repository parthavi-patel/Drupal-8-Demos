...
/**
 * @file
 * Contains \Drupal\hookevent\ExampleEventSubScriber.
 */

namespace Drupal\hookevent\EventSubscriber;

use Drupal\Core\Config\ConfigCrudEvent;
use Drupal\Core\Config\ConfigEvents;
use Drupal\hookevent\ExampleEvent;
...
class ExampleEventSubScriber implements EventSubscriberInterface {
  ...
  public function onSavingConfig(ConfigCrudEvent $event) {
    drupal_set_message("Testtttt --- You have saved a configuration of " . $event->getConfig()->getName());
  }
}